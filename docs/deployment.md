...
OpenSAC `v0.9.0` is available as version-matched service and sandbox images on GHCR.
...
docker run --detach \
  ...
  ghcr.io/liuqi6777/opensac:0.9.0 \
...
curl -fsSLo compose.yaml \
  https://raw.githubusercontent.com/liuqi6777/OpenSaC/v0.9.0/compose.yaml
curl -fsSLo .env \
  https://raw.githubusercontent.com/liuqi6777/OpenSaC/v0.9.0/.env.example
curl -fsSLo compose.env \
  https://raw.githubusercontent.com/liuqi6777/OpenSaC/v0.9.0/compose.env.example
mkdir -p configs
curl -fsSLo configs/docker.yaml \
  https://raw.githubusercontent.com/liuqi6777/OpenSaC/v0.9.0/configs/docker.yaml
mkdir -p "$PWD/.opensac"
