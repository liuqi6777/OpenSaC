...
SDK_SURFACE: tuple[OperationSpec, ...] = (
    ...
    OperationSpec("workspace", "write_jsonl", SurfaceTier.HELPER),
    OperationSpec("workspace", "append_jsonl", SurfaceTier.HELPER),
    OperationSpec("workspace", "upsert_jsonl", SurfaceTier.HELPER),
    OperationSpec("workspace", "exists", SurfaceTier.HELPER),
    OperationSpec("workspace", "list", SurfaceTier.HELPER),
    OperationSpec("workspace", "read_jsonl", SurfaceTier.HELPER),
    OperationSpec("workspace", "write_json", SurfaceTier.HELPER),
    OperationSpec("workspace", "read_json", SurfaceTier.HELPER),
    OperationSpec("workspace", "from_environment", SurfaceTier.INTERNAL),
